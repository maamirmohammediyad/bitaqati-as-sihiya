...
class _$MedicalFileImpl implements _MedicalFile {
  ...
  @override
  String toString() {
    return 'MedicalFile(id: $id, userId: $userId, originalName: $originalName, storagePath: $storagePath, fileType: $fileType, description: $description, sizeBytes: $sizeBytes, mimeType: $mimeType, url: $url, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
